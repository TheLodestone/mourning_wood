...
TREE_REGROW_TIME = 36000                 -- How long should it take individual trees to respawn after being cut down/destroyed?
...
CAMERA_DISTANCE_OVERRIDE = 1550.0       -- How far out should we allow the camera to go?  1134 is the default in Dota
...
FORCE_PICKED_HERO = "npc_dota_hero_shredder"                 -- What hero should we force all players to spawn as? (e.g. "npc_dota_hero_axe").  Use nil to allow players to pick their own hero.
